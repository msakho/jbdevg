...
public class EmbeddedCacheDemo {
	...
	private static final String SRC_MAIN_RESOURCES_INPUT_DIR = "src/main/resources/input/";
	...
	public static void main(String[] args) {
		...
		try {
			...
			for (String inputFile : inputFileNames) {
				record = FileUtils.getContentsAsString(new File(SRC_MAIN_RESOURCES_INPUT_DIR + inputFile));
